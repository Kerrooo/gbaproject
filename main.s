...
number10:
	...
	.global	number20
	.align	2
	.type	number20, %object
	.size	number20, 4
number20:
	.word	5
	.global	number21
	.align	2
	.type	number21, %object
	.size	number21, 4
number21:
	.word	6
	.global	number22
	.align	2
	.type	number22, %object
	.size	number22, 4
number22:
	.word	4
	.global	number23
	.align	2
	.type	number23, %object
	.size	number23, 4
number23:
	.word	8
	.global	number24
	.align	2
	.type	number24, %object
	.size	number24, 4
number24:
	.word	6
	.global	number25
	.align	2
	.type	number25, %object
	.size	number25, 4
number25:
	.word	8
	.global	number26
	.align	2
	.type	number26, %object
	.size	number26, 4
number26:
	.word	5
	.global	number27
	.align	2
	.type	number27, %object
	.size	number27, 4
number27:
	.word	6
	.global	number28
	.align	2
	.type	number28, %object
	.size	number28, 4
number28:
	.word	6
	.global	number29
	.align	2
	.type	number29, %object
	.size	number29, 4
number29:
	.word	3
	.global	number30
	.align	2
	.type	number30, %object
	.size	number30, 4
number30:
	.word	6
	.global	xuser
...
resettimer:
	...
	ldr	r2, .L66+136
	ldr	r3, .L66+140
	str	ip, [r2, #0]	@  number10
	str	r1, [r3, #0]	@  finish_y
.L62:
	cmp	r5, #2
	beq	.L63
	ldr	r3, .L66+144
	...
	mov	lr, #5
	mov	r4, #8
	str	r4, [r2, #0]	@  number25
	str	lr, [r3, #0]	@  number26
	ldr	r2, .L66+156
	ldr	r3, .L66+160
	mov	r1, #0
	mov	r0, #3
	...
	ldr	r2, .L66+256
	mov	ip, #6
	str	lr, [r3, #0]	@  number20
	str	ip, [r2, #0]	@  number21
	ldr	r3, .L66+260
	ldr	r2, .L66+264
	str	r4, [r3, #0]	@  number23
	str	ip, [r2, #0]	@  number24
	ldr	r3, .L66+268
	ldr	r2, .L66+272
	str	ip, [r3, #0]	@  number27
	str	ip, [r2, #0]	@  number28
	ldr	r3, .L66+276
	ldr	r2, .L66+280
	str	ip, [r3, #0]	@  number30
	str	r1, [r2, #0]	@  finish_y2
.L63:
	cmp	r5, #3
	ldrne	r3, .L66+284
	movne	r2, #0
...
.L92:
	...
	.word	replay10
	.word	sec
	.size	bigcount, .-bigcount
	.align	2
	.global	drawvehicle
	.type	drawvehicle, %function
drawvehicle:
	@ Function supports interworking.
	...
	sub	fp, ip, #-4294967292
	ldr	ip, [fp, #8]	@  interval,  interval
	ldr	sl, [fp, #20]	@  replay,  replay
	add	lr, ip, ip, asl #1	@  interval,  interval
	add	lr, ip, lr, asl #2	@  interval
	ldr	r4, [sl, #0]	@ * replay
	add	ip, ip, lr, asl #2	@  interval
	cmp	r4, ip
	mov	lr, r3	@  x
	mov	r4, r2	@  speed
	mov	r7, r0	@  veh
	mov	r8, r1	@  id
	ldr	r5, [fp, #4]	@  y,  y
	ldr	ip, [fp, #12]	@  starttime,  starttime
	ldr	r6, [fp, #16]	@  nooftimes,  nooftimes
	blt	.L94
	ldr	r3, [r6, #0]	@ * nooftimes
	cmp	r3, #0
	ble	.L94
	ldr	r3, .L106
	ldr	r2, [r3, #0]	@  sec
...
drawRoad:
	...
	ldr	r2, [r2, #0]
	cmp	r2, #16
	ldrgt	r2, [fp, #-52]	@  road_y
	str	r3, [fp, #-56]	@  x_start
	str	r0, [fp, #-44]	@  road1
	movgt	r3, #0
	str	r1, [fp, #-48]	@  road2
	ldr	sl, [fp, #4]	@  width,  width
	ldr	r5, [fp, #8]	@  road_id,  road_id
	mov	r9, #0	@  j
	strgt	r3, [r2, #0]
	movgt	r2, r3
.L121:
...
.L125:
	...
	ldmea	fp, {r4, r5, r6, r7, r8, r9, sl, fp, sp, lr}
	bx	lr
	.size	drawRoad, .-drawRoad
	.align	2
	.global	drawStationary
	.type	drawStationary, %function
drawStationary:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 1, uses_anonymous_args = 0
...
.L141:
	...
	ldmea	fp, {r4, r5, r6, r7, r8, fp, sp, lr}
	bx	lr
	.size	drawYMoving, .-drawYMoving
	.align	2
	.global	drawXLineMoving
	.type	drawXLineMoving, %function
drawXLineMoving:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 1, uses_anonymous_args = 0
...
.L187:
	...
	mov	r1, r9
	mov	r2, r9
	stmib	sp, {r4, r6, ip, lr}	@ phole stm
	str	sl, [sp, #0]
	bl	drawvehicle
	ldr	r2, .L247+296
	ldr	ip, .L247+180
...
.L258:
	...
	.comm	palm_y2,4,4
	.comm	road_y2,4,4
	.comm	bridgeleft_y,4,4
	.comm	bridgeright_y,4,4
	.comm	lavaleft_y,4,4
	.comm	lavaright_y,4,4
	.ident	"GCC: (GNU) 3.3.6"
